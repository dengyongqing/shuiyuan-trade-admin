...
//   contact: null
// createTime: "2019-11-18 17:30:23"
// id: 1
// password: "admin"
// remark: null
// role: "admin"
// userName: "admin"
  ...
  columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Fragment>
          <Popconfirm placement="top" title={'你确定要删除吗？'} onConfirm={() => this.deleteUser(record)} okText="Yes" cancelText="No">
            <a>删除</a>
          </Popconfirm>
  ...
  render() {
    const {
      userManage: { userList, pagination },
      loading,
    } = this.props;
