...
// area: "上海黄浦区"
// company: "zhongan"
// createDate: "2019-11-26 10:17:44"
...
// fixedphone: "0"
  ...
  handleDownloadOrder = (e) => {
    ...
    const { sendTimeStart, sendTimeEnd, keyWord } = this.state;
        ...
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <span className={styles.submitButtons}>
              ...
              <Button style={{ marginLeft: '30px' }} icon="download" type="primary" onClick={this.handleDownloadOrder}>
                导出订单
              </Button>
            </span>
          </Col>
  ...
  render() {
    const {
      company: { companyList, pagination },
      loading,
    } = this.props;
